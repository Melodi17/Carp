...
public class NativeConstrainedFunction : NativeFunction
{
    ...
    public NativeConstrainedFunction(
        CarpType returnType,
        Func<CarpObject?, CarpObject[], CarpObject> func,
        CarpType[] argTypes) : base(returnType, func)
    {
    ...
    {
        return args.Length == this._argTypes.Length
